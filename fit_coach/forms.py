...
class QuestionnaireForm(forms.Form):
    ...
    gender = forms.ChoiceField(choices=gender, widget=forms.RadioSelect(attrs={'class': 'form-check-input'}),
                               label='Gender')
    interest = forms.ChoiceField(choices=interest_choices, widget=forms.Select(attrs={'class': 'form-select'}),
